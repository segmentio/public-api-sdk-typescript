...
export class EdgeFunctionsApi {
     ...
     * @param sourceId
     * @param CreateEdgeFunctionAlphaInput
     */
    public async createEdgeFunction(
        sourceId: string,
        ...
        const localVarPath =
            this.basePath +
            '/sources/{sourceId}/edge-functions/create'.replace(
                '{' + 'sourceId' + '}',
        ...
        if (sourceId === null || sourceId === undefined) {
            throw new Error(
                'Required parameter sourceId was null or undefined when calling createEdgeFunction.'
            );
        }

        // verify required parameter 'CreateEdgeFunctionAlphaInput' is not null or undefined
        if (
            CreateEdgeFunctionAlphaInput === null ||
            CreateEdgeFunctionAlphaInput === undefined
        ) {
            throw new Error(
                'Required parameter CreateEdgeFunctionAlphaInput was null or undefined when calling createEdgeFunction.'
            );
        }
     ...
     * @summary Delete Edge Function Code
     * @param sourceId
     */
    public async deleteEdgeFunctionCode(
        sourceId: string,
        options: { headers: { [name: string]: string } } = { headers: {} }
    ): Promise<{
        response: http.IncomingMessage;
        ...
        const localVarPath =
            this.basePath +
            '/sources/{sourceId}/edge-functions/delete-code'.replace(
                '{' + 'sourceId' + '}',
                encodeURIComponent(String(sourceId))
            );
        let localVarQueryParameters: any = {};
        ...
        if (sourceId === null || sourceId === undefined) {
            throw new Error(
                'Required parameter sourceId was null or undefined when calling deleteEdgeFunctionCode.'
            );
        }
