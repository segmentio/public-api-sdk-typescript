...
import { CreateAudiencePreview200Response2 } from '../model/createAudiencePreview200Response2';
...
import { ForceExecuteAudienceRun200Response1 } from '../model/forceExecuteAudienceRun200Response1';
...
import { GetAudience200Response2 } from '../model/getAudience200Response2';
...
import { GetAudiencePreview200Response2 } from '../model/getAudiencePreview200Response2';
import { GetAudienceScheduleFromSpaceAndAudience200Response } from '../model/getAudienceScheduleFromSpaceAndAudience200Response';
import { GetAudienceScheduleFromSpaceAndAudience200Response1 } from '../model/getAudienceScheduleFromSpaceAndAudience200Response1';
...
import { ListAudienceConsumersFromSpaceAndAudience200Response1 } from '../model/listAudienceConsumersFromSpaceAndAudience200Response1';
...
import { ListAudienceSchedulesFromSpaceAndAudience200Response1 } from '../model/listAudienceSchedulesFromSpaceAndAudience200Response1';
...
import { ListAudiences200Response2 } from '../model/listAudiences200Response2';
...
import { RemoveAudienceFromSpace200Response2 } from '../model/removeAudienceFromSpace200Response2';
import { RemoveAudienceScheduleFromAudience200Response } from '../model/removeAudienceScheduleFromAudience200Response';
import { RemoveAudienceScheduleFromAudience200Response1 } from '../model/removeAudienceScheduleFromAudience200Response1';
...
import { UpdateAudienceScheduleForAudience200Response1 } from '../model/updateAudienceScheduleForAudience200Response1';
...
export class AudiencesApi {
     ...
     * @param spaceId
     * @param id
     * @param AddAudienceScheduleToAudienceInput
     */
    public async addAudienceScheduleToAudience(
        ...
        // verify required parameter 'AddAudienceScheduleToAudienceInput' is not null or undefined
        if (
            AddAudienceScheduleToAudienceInput === null ||
            AddAudienceScheduleToAudienceInput === undefined
        ) {
            throw new Error(
                'Required parameter AddAudienceScheduleToAudienceInput was null or undefined when calling addAudienceScheduleToAudience.'
            );
        }
    ...
    public async createAudience(
        ...
        // verify required parameter 'CreateAudienceInput' is not null or undefined
        if (CreateAudienceInput === null || CreateAudienceInput === undefined) {
            throw new Error(
                'Required parameter CreateAudienceInput was null or undefined when calling createAudience.'
            );
        }
     ...
     * @param spaceId
     * @param CreateAudiencePreviewInput
     */
    public async createAudiencePreview(
        ...
        // verify required parameter 'CreateAudiencePreviewInput' is not null or undefined
        if (
            CreateAudiencePreviewInput === null ||
            CreateAudiencePreviewInput === undefined
        ) {
            throw new Error(
                'Required parameter CreateAudiencePreviewInput was null or undefined when calling createAudiencePreview.'
            );
        }
     ...
     * @summary Get Audience Csv Export from Space And Audience
     * @param spaceId
     * @param id
     * @param exportId
     */
    public async getAudienceCsvExportFromSpaceAndAudience(
        spaceId: string,
        id: string,
        exportId: string,
        options: { headers: { [name: string]: string } } = { headers: {} }
        ...
        const localVarPath =
            ...
            '/spaces/{spaceId}/audiences/{id}/csv-exports/{exportId}'
                ...
                .replace(
                    '{' + 'exportId' + '}',
                    encodeURIComponent(String(exportId))
                );
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign(
            {},
        ...
        if (spaceId === null || spaceId === undefined) {
            throw new Error(
                'Required parameter spaceId was null or undefined when calling getAudienceCsvExportFromSpaceAndAudience.'
            );
        }
        ...
        if (id === null || id === undefined) {
            throw new Error(
                'Required parameter id was null or undefined when calling getAudienceCsvExportFromSpaceAndAudience.'
            );
        }
        ...
        if (exportId === null || exportId === undefined) {
            throw new Error(
                'Required parameter exportId was null or undefined when calling getAudienceCsvExportFromSpaceAndAudience.'
            );
        }
     ...
     * @param id
     * @param scheduleId
     * @param UpdateAudienceScheduleForAudienceInput
     */
    public async updateAudienceScheduleForAudience(
        ...
        // verify required parameter 'UpdateAudienceScheduleForAudienceInput' is not null or undefined
        if (
            UpdateAudienceScheduleForAudienceInput === null ||
            UpdateAudienceScheduleForAudienceInput === undefined
        ) {
            throw new Error(
                'Required parameter UpdateAudienceScheduleForAudienceInput was null or undefined when calling updateAudienceScheduleForAudience.'
            );
        }
