...
export class ReverseETLApi {
     ...
     * @summary Get Reverse ETL Sync Statuses By Subscription Id
     * @param modelId
     * @param subscriptionId
     * @param pagination Optional pagination params.  This parameter exists in alpha.
     */
    public async getReverseETLSyncStatusesBySubscriptionId(
        modelId: string,
        ...
        if (modelId === null || modelId === undefined) {
            throw new Error(
                'Required parameter modelId was null or undefined when calling getReverseETLSyncStatusesBySubscriptionId.'
            );
        }
        ...
        if (subscriptionId === null || subscriptionId === undefined) {
            throw new Error(
                'Required parameter subscriptionId was null or undefined when calling getReverseETLSyncStatusesBySubscriptionId.'
            );
        }
