...
export enum DataGraphSchemaApiApiKeys {}

export class DataGraphSchemaApi {
    ...
    public setApiKey(key: DataGraphSchemaApiApiKeys, value: string) {
        (this.authentications as any)[DataGraphSchemaApiApiKeys[key]].apiKey =
            value;
    }
