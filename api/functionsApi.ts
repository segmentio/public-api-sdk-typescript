...
export class FunctionsApi {
     ...
     * @summary Create Transformation Function Instance
     * @param CreateTransformationFunctionInstanceAlphaInput
     */
    public async createTransformationFunctionInstance(
        ...
        const localVarPath =
            this.basePath + '/transformation-function-instances';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign(
            {},
            this._defaultHeaders
        ...
        // verify required parameter 'CreateTransformationFunctionInstanceAlphaInput' is not null or undefined
        if (
            CreateTransformationFunctionInstanceAlphaInput === null ||
            CreateTransformationFunctionInstanceAlphaInput === undefined
        ) {
            throw new Error(
                'Required parameter CreateTransformationFunctionInstanceAlphaInput was null or undefined when calling createTransformationFunctionInstance.'
            );
        }
