...
export class FunctionsApi {
    ...
    public async handleWebhook(
        ...
        const localVarPath = this.basePath + '/functions/webhook';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign(
            {},
            this._defaultHeaders
        ...
        // verify required parameter 'HandleWebhookInput' is not null or undefined
        if (HandleWebhookInput === null || HandleWebhookInput === undefined) {
            throw new Error(
                'Required parameter HandleWebhookInput was null or undefined when calling handleWebhook.'
            );
        }
