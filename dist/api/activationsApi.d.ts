...
export declare class ActivationsApi {
    ...
    listSupportedDestinationsFromAudience(spaceId: string, audienceType: string, slug?: string, actionId?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    removeDestinationFromAudience(spaceId: string, audienceId: string, destinationId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: RemoveDestinationFromAudience200Response;
    }>;
