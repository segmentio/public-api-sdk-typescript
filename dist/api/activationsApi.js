    ...
    ActivationsApi.prototype.updateDestinationForAudience = function (spaceId, audienceId, destinationId, UpdateDestinationForAudienceAlphaInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling updateDestinationForAudience.');
                }
                if (audienceId === null || audienceId === undefined) {
                    throw new Error('Required parameter audienceId was null or undefined when calling updateDestinationForAudience.');
                }
                if (destinationId === null || destinationId === undefined) {
                    throw new Error('Required parameter destinationId was null or undefined when calling updateDestinationForAudience.');
                }
                if (UpdateDestinationForAudienceAlphaInput === null ||
                    UpdateDestinationForAudienceAlphaInput === undefined) {
                    throw new Error('Required parameter UpdateDestinationForAudienceAlphaInput was null or undefined when calling updateDestinationForAudience.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(UpdateDestinationForAudienceAlphaInput, 'UpdateDestinationForAudienceAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'UpdateDestinationForAudience200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
