...
var AudiencesApi = (function () {
    ...
    AudiencesApi.prototype.getAudienceEcho = function (spaceId, message, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath +
                    '/spaces/{spaceId}/audiences/echo'.replace('{' + 'spaceId' + '}', encodeURIComponent(String(spaceId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = [
                    'application/vnd.segment.v1alpha+json',
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling getAudienceEcho.');
                }
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'GetAudienceEcho200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
