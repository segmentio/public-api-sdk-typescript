...
exports.AudiencesApi = exports.AudiencesApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.segmentapis.com';
var AudiencesApiApiKeys;
(function (AudiencesApiApiKeys) {
})(AudiencesApiApiKeys = exports.AudiencesApiApiKeys || (exports.AudiencesApiApiKeys = {}));
var AudiencesApi = (function () {
    function AudiencesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AudiencesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AudiencesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(AudiencesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    AudiencesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AudiencesApi.prototype.setApiKey = function (key, value) {
        this.authentications[AudiencesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(AudiencesApi.prototype, "accessToken", {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling addAudienceCsvExportToAudience.');
                }
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        ...
                                        body = models_1.ObjectSerializer.deserialize(body, 'AddAudienceCsvExportToAudience200Response');
    ...
    AudiencesApi.prototype.addAudienceScheduleToAudience = function (spaceId, id, AddAudienceScheduleToAudienceInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling addAudienceScheduleToAudience.');
                }
                if (id === null || id === undefined) {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'AddAudienceScheduleToAudience200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.forceExecuteAudienceRun = function (spaceId, audienceId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling forceExecuteAudienceRun.');
                }
                if (audienceId === null || audienceId === undefined) {
                    throw new Error('Required parameter audienceId was null or undefined when calling forceExecuteAudienceRun.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'ForceExecuteAudienceRun200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.getAudienceScheduleFromSpaceAndAudience = function (spaceId, id, scheduleId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling getAudienceScheduleFromSpaceAndAudience.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling getAudienceScheduleFromSpaceAndAudience.');
                }
                if (scheduleId === null || scheduleId === undefined) {
                    throw new Error('Required parameter scheduleId was null or undefined when calling getAudienceScheduleFromSpaceAndAudience.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'GetAudienceScheduleFromSpaceAndAudience200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.listAudienceSchedulesFromSpaceAndAudience = function (spaceId, id, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling listAudienceSchedulesFromSpaceAndAudience.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling listAudienceSchedulesFromSpaceAndAudience.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'ListAudienceSchedulesFromSpaceAndAudience200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.removeAudienceFromSpace = function (spaceId, id, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling removeAudienceFromSpace.');
                }
                if (id === null || id === undefined) {
                    throw new Error('Required parameter id was null or undefined when calling removeAudienceFromSpace.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'RemoveAudienceFromSpace200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.removeAudienceScheduleFromAudience = function (spaceId, id, scheduleId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling removeAudienceScheduleFromAudience.');
                }
                if (id === null || id === undefined) {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'RemoveAudienceScheduleFromAudience200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    AudiencesApi.prototype.updateAudienceForSpace = function (spaceId, id, UpdateAudienceForSpaceInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling updateAudienceForSpace.');
                }
                if (id === null || id === undefined) {
...
//# sourceMappingURL=audiencesApi.js.map