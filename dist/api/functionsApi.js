...
var FunctionsApi = (function () {
    ...
    FunctionsApi.prototype.createFunction = function (CreateFunctionV1Input, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (CreateFunctionV1Input === null ||
                    ...
                    throw new Error('Required parameter CreateFunctionV1Input was null or undefined when calling createFunction.');
                }
    ...
    FunctionsApi.prototype.createFunctionDeployment = function (functionId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (functionId === null || functionId === undefined) {
                    throw new Error('Required parameter functionId was null or undefined when calling createFunctionDeployment.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    FunctionsApi.prototype.createInsertFunctionInstance = function (CreateInsertFunctionInstanceAlphaInput, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (CreateInsertFunctionInstanceAlphaInput === null ||
                    ...
                    throw new Error('Required parameter CreateInsertFunctionInstanceAlphaInput was null or undefined when calling createInsertFunctionInstance.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(CreateInsertFunctionInstanceAlphaInput, 'CreateInsertFunctionInstanceAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'CreateInsertFunctionInstance200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
            ...
            return __generator(this, function (_b) {
                ...
                if (resourceType !== undefined) {
                    localVarQueryParameters['resourceType'] =
                        models_1.ObjectSerializer.serialize(resourceType, "'DESTINATION' | 'INSERT' | 'INSERT_DESTINATION' | 'INSERT_SOURCE' | 'SOURCE'");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    FunctionsApi.prototype.restoreFunctionVersion = function (functionId, RestoreFunctionVersionAlphaInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (functionId === null || functionId === undefined) {
                    throw new Error('Required parameter functionId was null or undefined when calling restoreFunctionVersion.');
                }
                if (RestoreFunctionVersionAlphaInput === null ||
                    RestoreFunctionVersionAlphaInput === undefined) {
                    throw new Error('Required parameter RestoreFunctionVersionAlphaInput was null or undefined when calling restoreFunctionVersion.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(RestoreFunctionVersionAlphaInput, 'RestoreFunctionVersionAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'RestoreFunctionVersion200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    FunctionsApi.prototype.updateFunction = function (functionId, UpdateFunctionV1Input, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (functionId === null || functionId === undefined) {
                    throw new Error('Required parameter functionId was null or undefined when calling updateFunction.');
                }
                if (UpdateFunctionV1Input === null ||
                    UpdateFunctionV1Input === undefined) {
                    throw new Error('Required parameter UpdateFunctionV1Input was null or undefined when calling updateFunction.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
    ...
    FunctionsApi.prototype.updateInsertFunctionInstance = function (instanceId, UpdateInsertFunctionInstanceAlphaInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (instanceId === null || instanceId === undefined) {
                    throw new Error('Required parameter instanceId was null or undefined when calling updateInsertFunctionInstance.');
                }
                if (UpdateInsertFunctionInstanceAlphaInput === null ||
                    UpdateInsertFunctionInstanceAlphaInput === undefined) {
                    throw new Error('Required parameter UpdateInsertFunctionInstanceAlphaInput was null or undefined when calling updateInsertFunctionInstance.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(UpdateInsertFunctionInstanceAlphaInput, 'UpdateInsertFunctionInstanceAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'UpdateInsertFunctionInstance200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
