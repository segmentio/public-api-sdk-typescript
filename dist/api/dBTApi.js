    ...
    DBTApi.prototype.createDbtModelSyncTrigger = function (CreateDbtModelSyncTriggerInput, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/dbt-model-syncs/trigger';
                ...
                if (CreateDbtModelSyncTriggerInput === null ||
                    ...
                    throw new Error('Required parameter CreateDbtModelSyncTriggerInput was null or undefined when calling createDbtModelSyncTrigger.');
                }
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(CreateDbtModelSyncTriggerInput, 'CreateDbtModelSyncTriggerInput'),
                };
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        ...
                                        body = models_1.ObjectSerializer.deserialize(body, 'CreateDbtModelSyncTrigger200Response');
