...
var ProfilesSyncApi = (function () {
    ...
    ProfilesSyncApi.prototype.listProfilesWarehouseInSpace = function (spaceId, pagination, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling listProfilesWarehouseInSpace.');
                }
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'ListProfilesWarehouseInSpace200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    ProfilesSyncApi.prototype.listSelectiveSyncsFromWarehouseAndSpace = function (spaceId, warehouseId, pagination, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProfilesSyncApi.prototype.removeProfilesWarehouseFromSpace = function (spaceId, warehouseId, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling removeProfilesWarehouseFromSpace.');
                }
                if (warehouseId === null || warehouseId === undefined) {
                    throw new Error('Required parameter warehouseId was null or undefined when calling removeProfilesWarehouseFromSpace.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'RemoveProfilesWarehouseFromSpace200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    ProfilesSyncApi.prototype.updateProfilesWarehouseForSpaceWarehouse = function (spaceId, warehouseId, UpdateProfilesWarehouseForSpaceWarehouseAlphaInput, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling updateProfilesWarehouseForSpaceWarehouse.');
                }
                if (warehouseId === null || warehouseId === undefined) {
                    throw new Error('Required parameter warehouseId was null or undefined when calling updateProfilesWarehouseForSpaceWarehouse.');
                }
                if (UpdateProfilesWarehouseForSpaceWarehouseAlphaInput === null ||
                    UpdateProfilesWarehouseForSpaceWarehouseAlphaInput === undefined) {
                    throw new Error('Required parameter UpdateProfilesWarehouseForSpaceWarehouseAlphaInput was null or undefined when calling updateProfilesWarehouseForSpaceWarehouse.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(UpdateProfilesWarehouseForSpaceWarehouseAlphaInput, 'UpdateProfilesWarehouseForSpaceWarehouseAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'UpdateProfilesWarehouseForSpaceWarehouse200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
    ...
    ProfilesSyncApi.prototype.updateSelectiveSyncForWarehouseAndSpace = function (spaceId, warehouseId, UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarFormParams = {};
                if (spaceId === null || spaceId === undefined) {
                    throw new Error('Required parameter spaceId was null or undefined when calling updateSelectiveSyncForWarehouseAndSpace.');
                }
                if (warehouseId === null || warehouseId === undefined) {
                    throw new Error('Required parameter warehouseId was null or undefined when calling updateSelectiveSyncForWarehouseAndSpace.');
                }
                if (UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput === null ||
                    UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput === undefined) {
                    throw new Error('Required parameter UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput was null or undefined when calling updateSelectiveSyncForWarehouseAndSpace.');
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput, 'UpdateSelectiveSyncForWarehouseAndSpaceAlphaInput'),
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications.token.accessToken) {
                    authenticationPromise = authenticationPromise.then(function () {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        response.statusCode >= 200 &&
                                        response.statusCode <= 299) {
                                        body = models_1.ObjectSerializer.deserialize(body, 'UpdateSelectiveSyncForWarehouseAndSpace200Response');
                                        resolve({ response: response, body: body });
                                    }
                                    else {
                                        reject(new apis_1.HttpError(response, body, response.statusCode));
