...
exports.WorkspacesApi = exports.WorkspacesApiApiKeys = void 0;
var request_1 = __importDefault(require("request"));
var models_1 = require("../model/models");
var models_2 = require("../model/models");
var apis_1 = require("./apis");
var defaultBasePath = 'https://api.segmentapis.com';
var WorkspacesApiApiKeys;
(function (WorkspacesApiApiKeys) {
})(WorkspacesApiApiKeys = exports.WorkspacesApiApiKeys || (exports.WorkspacesApiApiKeys = {}));
var WorkspacesApi = (function () {
    function WorkspacesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(WorkspacesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(WorkspacesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(WorkspacesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    WorkspacesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    WorkspacesApi.prototype.setApiKey = function (key, value) {
        this.authentications[WorkspacesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(WorkspacesApi.prototype, "accessToken", {
    ...
    WorkspacesApi.prototype.addInterceptor = function (interceptor) {
        this.interceptors.push(interceptor);
    };
    WorkspacesApi.prototype.getWorkspaceAlpha = function (options) {
                            ...
                            (0, request_1.default)(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    if (response.statusCode &&
                                        ...
                                        body = models_1.ObjectSerializer.deserialize(body, 'GetWorkspace200Response');
    ...
    WorkspacesApi.prototype.getWorkspaceBeta = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    WorkspacesApi.prototype.getWorkspaceCurrent = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    WorkspacesApi.prototype.getWorkspaceV1 = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
