...
var FiltersApi = (function () {
    ...
    FiltersApi.prototype.deleteFilterById = function (id, productArea, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (productArea === null || productArea === undefined) {
                    throw new Error('Required parameter productArea was null or undefined when calling deleteFilterById.');
                }
    ...
    FiltersApi.prototype.getFilterById = function (id, productArea, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (productArea === null || productArea === undefined) {
                    throw new Error('Required parameter productArea was null or undefined when calling getFilterById.');
                }
                if (productArea !== undefined) {
                    localVarQueryParameters['productArea'] = models_1.ObjectSerializer.serialize(productArea, 'string');
                }
    ...
    FiltersApi.prototype.listFiltersByIntegrationId = function (integrationId, productArea, pagination, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
